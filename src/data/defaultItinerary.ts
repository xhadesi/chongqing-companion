...
export const DEFAULT_ITINERARY: TripDay[] = [
    {
        ...
        activities: [
            ...
            },
            {
                ...
                description: "Pour ton premier soir, l'idéal est de plonger direct dans l'ambiance nocturne de Jiefangbei. Les rues fourmillent de stands de street food et de petites échoppes fumantes de Shao Kao (brochettes grillées). Les odeurs de cumin, de piment sec et d'huile sésame vont t'envelopper.",
    ...
    },
    {
        ...
        activities: [
            ...
            },
            {
                ...
                description: "Cachés dans les hauts étages des gratte-ciels de Jiefangbei se trouvent des tailleurs de grand talent (souvent formés au style Hong Kong). Ce premier rendez-vous sert à choisir les étoffes, prendre tes mesures précises, et définir la coupe globale. Compte environ 2000 RMB pour un ensemble complet. L'objectif est d'avoir ce costume prêt pour tes soirées en fin de séjour.",
            ...
            },
            {
                ...
                description: "Un restaurant élégant, perché en hauteur, offrant des larges baies vitrées donnant sur la nuit de Chongqing, où les néons des bateaux se reflètent sur le Jialing. Le repas sera fin, typique, et l'atmosphère tamisée.",
        ...
        activities: [
            {
                ...
                time: "11:00",
                duration: "1h30",
                title: "Dentiste VIP (Détartrage, Caries)",
                description: "L'expérience médicale premium en Chine est bluffante de confort. Dans un cabinet au design de spa avec fauteuils massants et vue en hauteur sur la ville de Jiangbei, tu t'offriras un soin profond (le matériel aux normes internationales est ultra-moderne).",
            ...
            },
            {
                ...
                time: "22:00",
                duration: "3h",
                title: "Nightlife EDM Ultra-Club (Nine Street)",
                description: "Prépare-toi à un choc sismique. La Nine Street (Jiujie) est l'épicentre mondial de la fête opulente à Chongqing. Les clubs immenses (Space Club, Play House) bombardent un EDM cataclysmique, avec des écrans LED de 15 mètres, des confettis, et des tables bourrées d'alcool fort et de glaçons lumineux.",
    ...
    },
    {
        ...
        activities: [
            ...
            },
            {
                ...
                time: "20:00",
                duration: "3h",
                title: "Date au Bar VIP Lounge (Nanbin Road)",
                description: "Sur les quais du Sud (Nanbin Road), les bars d'hôtel de luxe et les lounges de cocktails haut perchés déroulent un luxe insolent : pianiste jazz en direct, dalles numériques interactives, et murs de bouteilles infinies. La vue de nuit sur Yuzhong de l'autre côté du fleuve noir est féérique.",
    ...
    },
    {
        ...
        activities: [
            ...
            },
            {
                ...
                time: "21:30",
                duration: "3h",
                title: "Bars Mixtes au Centro (Locaux & Expats)",
                description: "Contrairement à la zone du chaos de Nine Street au nord (EDM ravageur), cette zone du centre (autour des bars Helen's, Revolucion Cocktail) distille une ambiance lounge hip-hop moite et conviviale de bière artisanale (Craft beer), musique chaloupée, et population hybride, mélangeant expatriés trentenaires et jeunesse métropolitaine ouverte d'esprit.",
    ...
    },
    {
        ...
        activities: [
            ...
            },
            {
                ...
                time: "19:00",
                duration: "2h30",
                title: "Grand Banquet Gastronomique Chinois d'Adieu",
                description: "Dernière nuit à la couronne ! Fin du voyage d'investigation : habille-toi de ta meilleure sape et offre-toi ou fais-toi inviter avec les personnes du voyage pour un banquet luxurieux. Les plus formidables restaurant se targuent d'immense chaises sculptée lourdes, d'un canard pékinois laqué rôti à la perfection au feu de bois fruitier devant la table étincelante et découpé sur place avant de le glisser dans de fragiles crêpes translucide vapeur relevées à la sauce prune épaisse et d'ognons blancs croquants ultra sucrés.",
