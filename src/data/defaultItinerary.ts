    ...
    },
    {
        ...
        activities: [
            ...
            },
            {
                ...
                time: "10:30",
                duration: "2h",
                title: "Rendez-vous Tailleur (Suit Republic WFC)",
                description: "Cachés dans les hauts étages des gratte-ciels de Jiefangbei, comme le WFC Mall, se trouvent des tailleurs de grand talent (souvent formés au style Hong Kong). Ce premier rendez-vous sert à choisir les étoffes, prendre tes mesures précises, et définir la coupe globale. Compte environ 2000 RMB pour un ensemble complet. L'objectif est d'avoir ce costume prêt pour tes soirées en fin de séjour.",
