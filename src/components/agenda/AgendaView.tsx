    ...
    return (
        <div className="flex flex-col h-full bg-slate-100 dark:bg-slate-950 min-h-screen relative">
            ...
            {isDetailsOpen && selectedActivity && (
                <div className="fixed inset-0 z-[60] bg-white dark:bg-slate-950 flex flex-col animate-in fade-in-100 slide-in-from-bottom-10 lg:slide-in-from-right-10 duration-300 overflow-y-auto custom-scrollbar shadow-2xl">
                    <div className="relative min-h-full flex flex-col bg-white dark:bg-slate-950">
